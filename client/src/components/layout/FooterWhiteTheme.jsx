...
export default function FooterWhiteTheme() {
  const footerLink = (
    <div className="grid grid-cols-3 gap-y-4 place-items-center my-5 text-[18px] font-light overflow-hidden transition-all md:flex md:gap-5 md:my-0">
  ...
  return (
    <>
      <footer className="sm-container-space lg:lg-container-space">
        <div
          id="footer-wrapper"
          className="footer container flex flex-col items-center mt-20 mb-[20vw] md:mb-0 text-black bg-white"
        >
          <div className="md:flex md:flex-row md:items-center md:w-full md:justify-between text-center">
            <Link to="/">
              <img src="/assets/RanVin.png" alt="" />
            </Link>
            {/* social media links */}
